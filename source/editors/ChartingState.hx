...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change NoteSkin', "Value 1: XBOOOOOOOOOOOOOOOOX LIIIIIIIIIIIIIIIIIIIIIIIIIIIVEEEEEEEEEE (bf noteskin)\nValue 2: AMBATAAABLOOOOOOOOOU (dad noteskin)."]
	];
	...
	**/
	...
	function addSongUI():Void
	{
		...
		if(skin == null) skin = '';
		noteSkinInputText = new FlxUIInputText(player2DropDown.x, player2DropDown.y + 50, 100, skin, 8);
		blockPressWhileTypingOn.push(noteSkinInputText);

		var skin2 = PlayState.SONG.arrowSkin2;
		if(skin2 == null) skin2 = '';
		noteSkinInputText2 = new FlxUIInputText(noteSkinInputText.x + noteSkinInputText.width + 10, noteSkinInputText.y, 100, skin2, 8);
		...
		var reloadNotesButton:FlxButton = new FlxButton(noteSplashesInputText.x + 5, noteSplashesInputText.y + 20, 'Change Notes', function() {
			...
			_song.arrowSkin2 = noteSkinInputText2.text;
			updateGrid();
		});
		...
		tab_group_song.add(noteSkinInputText2);
	...
	function loadSong():Void
	{
		...
		var file:Dynamic = Paths.voices(currentSongName, CoolUtil.difficulties[PlayState.storyDifficulty], _song.player1);
		vocals = new FlxSound();
	...
	function loadAudioBuffer() {
		...
		audioBuffers[0] = null;
		#if MODS_ALLOWED
		if(FileSystem.exists(Paths.modFolders('songs/' + currentSongName + '/' + currentSongName + '/Inst.ogg'))) {
			audioBuffers[0] = AudioBuffer.fromFile(Paths.modFolders('songs/' + currentSongName + '/' + currentSongName + 'Inst.ogg'));
			//trace('Custom vocals found');
		}
		else { #end
			var leVocals:String = Paths.getPath(currentSongName + '/' + _song.song + '/Inst.' + Paths.SOUND_EXT, SOUND, 'songs');
		...
		if(FileSystem.exists(Paths.modFolders('songs/' + currentSongName + '/Voices.ogg'))) {
			...
			var leVocals:String = Paths.getPath(currentSongName + '/'+ currentSongName + '/Voices.' + Paths.SOUND_EXT, SOUND, 'songs');
