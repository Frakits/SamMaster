...
class StoryMenuState extends MusicBeatState
{
	...
	var groupWeek:FlxTypedGroup<Alphabet>;
	...
	override function create()
	{
		...
		linearrow = new FlxSprite(-1280).loadGraphic(Paths.image("menuassets/linesStory", 'sam'));
		add(linearrow);
		add(arrow);
		add(arrow2);

		groupWeek = new FlxTypedGroup<Alphabet>();
		add(groupWeek);
